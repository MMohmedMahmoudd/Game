export class Ui {
            ...
            <div class="col-sm-12 col-md-2 col-lg-3 col-xl-3 ">
                <div data-id="${data[i].id}" class="card h-100 bg-transparent" role="button">
                    ...
                    <footer class="card-footer small hstack justify-content-between">
                        <span class=" px-3 bg-dark rounded-3 py-1">${data[i].genre}</span>
                        <span class=" px-3 bg-dark rounded-3 py-1">${data[i].platform}</span>
                    </footer>
                </div>
            </div>`;
        }
        document.getElementById("display").innerHTML = gamesBox;
    }
    ...
    displayDetails(data) {
        ...
        document.getElementById("detailsContainer").innerHTML = content;
    }
}
